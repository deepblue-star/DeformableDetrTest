...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default=TrainConstant.coco_path, type=str)
    parser.add_argument('--coco_panoptic_path', type=str)
    parser.add_argument('--remove_difficult', action='store_true')

    parser.add_argument('--output_dir', default=TrainConstant.output_path,
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default=TrainConstant.detect_model_path,
...
def main(args):
    ...
    model.cuda()
    model.eval()
    state_dict = torch.load(TrainConstant.detect_model_path)  # <-----------修改加载模型的路径
